...
const httpLink = createHttpLink({ uri: `https://api.graph.cool/simple/v1/cjk1lmpxc3z0401163qld3ahq` })

const wsLink = new WebSocketLink({
  uri: `wss://subscriptions.us-west-2.graph.cool/v1/cjk1lmpxc3z0401163qld3ahq`,
  options: {
    reconnect: true
  }
})
